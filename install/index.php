					    ...
					    <?php switch ($step) { default: ?>
    				        ...
    				        <div class="card__content">
        						<div class="card__content__head">
        							...
        							<p class="card__fade">This php extensions Are must needed! If you server don't have this Ask you server provider to enable it. This are commonly used php extension in all Hosting's. For Further Info Contact us in Telegram @nemosofts.</p>
        						</div>
        						<div class="card__fade">
        							...
        							<div class="card__content__foot">
        								<p>Copyright © <?php echo date('Y'); ?> <a target="_blank" href="https://nemosofts.com">nemosofts</a> All rights reserved.</p>
                    						...
                    						<div class="card__content">
                    							...
                    							<div class="card__fade">
                    							    <form action="index.php?step=1" method="POST">
                        								...
                        								<p style="margin-top: 10px;">Copyright © <?php echo date('Y'); ?> <a target="_blank" href="https://nemosofts.com">nemosofts</a> All rights reserved.</p>
                    								</form>
                    							</div>
                    						</div>
                                    <?php
