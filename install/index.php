                ...
                <div id="card" class="card">
                    <div class="card__body">
                        ...
                        <div class="card__image">
                            <?php if($errors==true){?>
                            <img src="https://assets.nemosofts.com/install/images/server_error.png" alt="">
                            <?php } else { ?>
                            <img src="https://assets.nemosofts.com/install/images/server_success.png" alt="">
                            <?php } ?>
                        </div>
                        <div class="card__content">
                            <div class="card__content__head">
                                <h3 class="card__title">
                                    <span><?php echo $product_info['product_name']; ?></span>
                                </h3>
                                <p class="card__fade">This php extensions Are must needed! If you server don't have this
                                    Ask you server provider to enable it. This are commonly used php extension in all
                                    Hosting's. For Further Info Contact us in Telegram @nemosofts.</p>
                            </div>
                            <div class="card__fade">
                                ...
                                <div class="card__content__foot">
                                    <p>Copyright © <?php echo date('Y'); ?> <a target="_blank"
                                            href="https://nemosofts.com">nemosofts</a> All rights reserved.</p>
                                    <div class="text-right">
                                        <?php if($errors==true){ ?>
                                        <button type="button" id="next" class="btn btn--primary btn--slide"
                                            style="min-width: 124px;" disabled>Next</button>
                                        <?php }else{ ?>
                                        <a href="index.php?step=0" class="btn btn--primary btn--slide"
                                            style="min-width: 124px;">Next</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form action="index.php?step=0" method="POST">
                                    <div class="mb-48">
                                        ...
                                        <div class="form-group">
                                            <svg class="form-group__icon" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <input class="form-control" type="text"
                                                placeholder="Enter your envato user name" name="client"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control mb-8" type="text"
                                                placeholder="Enter your item purchase code" name="license"
                                                autocomplete="off" required>
                                            <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code"
                                                class="text-red" target="_blank">Where Is My Purchase Code?</a>
                                        </div>
                                    </div>
                                    <div class="card__content__foot">
                                        <div class="text-right">
                                            <button type="submit" class="btn btn--primary btn--slide"
                                                style="min-width: 124px;">Verify</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card__fade">
                                <form action="index.php?step=1" method="POST">
                                    ...
                                    <div class="card__content__foot">
                                        <div class="text-right">
                                            <button type="submit" class="btn btn--primary btn--slide"
                                                style="min-width: 124px;">Next</button>
                                        </div>
                        ...
                        <div class="card__image">
                            <img src="https://assets.nemosofts.com/install/images/database.png" alt="">
                        </div>
                        <div class="card__content">
                            <div class="card__content__head">
                                <h3 class="card__title">
                            ...
                            <div class="card__fade">
                                <form action="index.php?step=1" method="POST">
                                    <div class="notify notify--error" style="margin-bottom: 18px;">
                                        ...
                                        <span class="notify__text">Failed to connect to MySQL:
                                            <?php echo mysqli_connect_error(); ?></span>
                                    </div>
                                    ...
                                    <div class="mb-16">
                                        ...
                                        <input class="form-control" type="text" id="host"
                                            placeholder="enter your database host" name="host" value="localhost"
                                            required>
                                    </div>
                                    <div class="mb-16">
                                    ...
                                    <div class="card__content__foot">
                                        <div class="text-right">
                                            <button type="submit" id="next" class="btn btn--primary btn--slide"
                                                style="min-width: 124px;">Import</button>
                                        </div>
                                    </div>
                                    <p style="margin-top: 10px;">Copyright © <?php echo date('Y'); ?> <a target="_blank"
                                            href="https://nemosofts.com">nemosofts</a> All rights reserved.</p>
                                </form>
                            </div>
                        </div>
                        ...
                        <?php if($_POST && isset($_POST["dbscs"])){
                            ...
                            ?>
                        <div class="card__image">
                            <img src="https://assets.nemosofts.com/install/images/finish.png" alt="">
                        </div>
                        <div class="card__content">
                            <div class="card__content__head">
                                <h3 class="card__title">
                            ...
                            <div class="card__fade">
                                <div class="notify notify--success mb-40">
                                    ...
                                    <span class="notify__text"><?php echo $product_info['product_name']; ?> is
                                        successfully installed.</span>
                                </div>
                                <p>You can now login using your username: <b style="color: #f44336c7;">admin</b> and
                                    default password: <b style="color: #f44336c7;">admin</b></p>
                                ...
                                <div class="card__foot">
                                    <p>We provide support through Email or Telegram. <br>
                                        <b>Email:</b> <a href="mailto:info.nemosofts@gmail.com"
                                            style="color: #2196f3;">info.nemosofts@gmail.com</a> <br>
                                        <b>Telegram:</b> <a href="https://t.me/nemosofts"
                                            style="color: #2196f3;">@nemosofts</a>
                                    </p>
                                </div>
